...
import { RegisterFormValues } from '../../redux/auth/user.type.ts';
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
              Sign Up to Avraamenko Admin Panel
            </h2>
            ...
            >
              {({
                ...
                <Form>
                  ...
                  <div className="mb-6">
                    <label htmlFor="passwordConfirmation" className="mb-2.5 block font-medium text-black dark:text-white">
                      Re-type Password
                    </label>
                    <div className="relative">
                      <Field
